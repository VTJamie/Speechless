...
export interface AlexaSliderRadialModel extends APLBaseComponentModel {
...
export interface AlexaSliderRadialProps extends APLBaseComponentProps {
  bufferValue?: Calculable<number>;
...
export class AlexaSliderRadial extends APLComponent<AlexaSliderRadialModel, AlexaSliderRadialProps> {
  constructor(props: AlexaSliderRadialProps) {
    super('AlexaSliderRadial', props);
  }

  componentSpecificModel(): AlexaSliderRadialModel {
    return {
      ...
      totalValue: this.props.bufferValue
    };
  }
